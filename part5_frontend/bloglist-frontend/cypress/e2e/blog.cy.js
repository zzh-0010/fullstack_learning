describe("Blog app", function () {
  ...
  describe("When have a blog", function () {
    ...
    it("sort the blogs", function () {
      ...
      cy.get(".showDetail")
        .contains("The blog with the most likes")
        .contains("like")
        .as("clicklike");
      ...
      cy.contains("The blog with the second most likes")
        .contains("view")
        .click();
      cy.get(".showDetail")
        .contains("The blog with the second most likes")
        .contains("like")
        .click();
      ...
      cy.get(".blog")
        .eq(1)
        .should("contain", "The blog with the second most likes");
